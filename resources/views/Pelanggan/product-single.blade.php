    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="Pelanggan/images/product-1.png" class="image-popup prod-img-bg"><img src="Pelanggan/images/product-1.png" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
              ...
              <div class="tab-pane fade" id="v-pills-3" role="tabpanel" aria-labelledby="v-pills-day-3-tab">
              	<div class="row p-4">
						   		<div class="col-md-7">
						   			...
						   			<div class="review">
								   		<div class="user-img" style="background-image: url(Pelanggan/images/person_1.jpg)"></div>
								   		<div class="desc">
								   			<h4>
								   	...
								   	<div class="review">
								   		<div class="user-img" style="background-image: url(Pelanggan/images/person_2.jpg)"></div>
								   		<div class="desc">
								   			<h4>
								   				<span class="text-left">Jacob Webb</span>
								   				<span class="text-right">14 March 2018</span>
								   	...
								   	<div class="review">
								   		<div class="user-img" style="background-image: url(Pelanggan/images/person_3.jpg)"></div>
								   		<div class="desc">
								   			<h4>
								   				<span class="text-left">Jacob Webb</span>
								   				<span class="text-right">14 March 2018</span>
