...
<html lang="en">
  <head>
    <title>Batik Ganasan Subang</title>
    <meta charset="utf-8">
  ...
  <body class="goto-here">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.blade.php">Minishop</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
                ...
                <a class="dropdown-item" href="product-single.blade.php">Single Product</a>
	          ...
	          <li class="nav-item"><a href="blog.blade.php" class="nav-link">Blog</a></li>
	          <li class="nav-item"><a href="contact.blade.php" class="nav-link">Contact</a></li>
	          <li class="nav-item cta cta-colored"><a href="cart.blade.php" class="nav-link"><span class="icon-shopping_cart"></span>[0]</a></li>
    				...
    				<div class="row">
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product d-flex flex-column">
		    					<a href="#" class="img-prod"><img class="img-fluid" src="Pelanggan/images/product-1.png" alt="Colorlib Template">
		    			...
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product d-flex flex-column">
		    					<a href="#" class="img-prod"><img class="img-fluid" src="Pelanggan/images/product-2.png" alt="Colorlib Template">
		    			...
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product">
		    					<a href="#" class="img-prod"><img class="img-fluid" src="Pelanggan/images/product-3.png" alt="Colorlib Template">
			    					<div class="overlay"></div>
			    				</a>
		    					<div class="text py-3 pb-4 px-3">
		    						<div class="d-flex">
		    			...
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product">
		    					<a href="#" class="img-prod"><img class="img-fluid" src="Pelanggan/images/product-4.png" alt="Colorlib Template">
		    						<div class="overlay"></div>
		    					</a>
		    					<div class="text py-3 pb-4 px-3">
		    						<div class="d-flex">
		    			...
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product d-flex flex-column">
		    					<a href="#" class="img-prod"><img class="img-fluid" src="Pelanggan/images/product-5.png" alt="Colorlib Template">
		    						<div class="overlay"></div>
		    					</a>
		    					<div class="text py-3 pb-4 px-3">
		    						<div class="d-flex">
		    			...
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product d-flex flex-column">
		    					<a href="#" class="img-prod"><img class="img-fluid" src="Pelanggan/images/product-6.png" alt="Colorlib Template">
		    						<span class="status">50% Off</span>
		    						<div class="overlay"></div>
		    					</a>
		    					<div class="text py-3 pb-4 px-3">
		    			...
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product">
		    					<a href="#" class="img-prod"><img class="img-fluid" src="Pelanggan/images/product-7.png" alt="Colorlib Template">
			    					<div class="overlay"></div>
			    				</a>
		    					<div class="text py-3 pb-4 px-3">
		    						<div class="d-flex">
		    			...
		    			<div class="col-sm-12 col-md-12 col-lg-4 ftco-animate d-flex">
		    				<div class="product">
		    					<a href="#" class="img-prod"><img class="img-fluid" src="Pelanggan/images/product-8.png" alt="Colorlib Template">
		    						<div class="overlay"></div>
		    					</a>
		    					<div class="text py-3 pb-4 px-3">
		    						<div class="d-flex">
  ...
  <script src="Pelanggan/js/jquery.min.Pelanggan/js"></script>
  <script src="Pelanggan/js/jquery-migrate-3.0.1.min.Pelanggan/js"></script>
  <script src="Pelanggan/js/popper.min.Pelanggan/js"></script>
  <script src="Pelanggan/js/bootstrap.min.Pelanggan/js"></script>
  <script src="Pelanggan/js/jquery.easing.1.3.Pelanggan/js"></script>
  <script src="Pelanggan/js/jquery.waypoints.min.Pelanggan/js"></script>
  <script src="Pelanggan/js/jquery.stellar.min.Pelanggan/js"></script>
  <script src="Pelanggan/js/owl.carousel.min.Pelanggan/js"></script>
  <script src="Pelanggan/js/jquery.magnific-popup.min.Pelanggan/js"></script>
  <script src="Pelanggan/js/aos.Pelanggan/js"></script>
  <script src="Pelanggan/js/jquery.animateNumber.min.Pelanggan/js"></script>
  <script src="Pelanggan/js/bootstrap-datepicker.Pelanggan/js"></script>
  <script src="Pelanggan/js/scrollax.min.Pelanggan/js"></script>
  <script src="https://maps.googleapis.com/maps/api/Pelanggan/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
  <script src="Pelanggan/js/google-map.Pelanggan/js"></script>
  <script src="Pelanggan/js/main.Pelanggan/js"></script>
