...
<html>
    ...
    <head>
        ...
        <title>
            User Profile | Soft UI Dashboard Bootstrap @ Creative Tim
        </title>
        <link rel="canonical" href="https://www.creative-tim.com/learning-lab/bootstrap/overview/soft-ui-dashboard">
        ...
        <link rel="stylesheet" href="Admin/assets/demo.css" type="text/css">
        ...
        <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700" rel="stylesheet">
        <link href="admin/assets/docs-soft.css" rel="stylesheet">
...
<body class="docs">
    ...
    <header class="ct-docs-navbar">
        <a class="ct-docs-navbar-brand" href="javascript:void(0)" aria-label="Bootstrap">
            ...
            <a href="admin/documentation/getting-started/installation.html" class="ct-docs-navbar-text">
                Docs
            </a>
    ...
    <div class="ct-docs-main-container">
                ...
                <nav class="ct-docs-sidebar-collapse-links">
                    <div class="ct-docs-sidebar-product">
                        <div class="ct-docs-sidebar-product-image">
                            <img src="admin/assets/img/bootstrap-5.svg">
                        </div>
                    ...
                    <div class="ct-docs-toc-item-active">
                        ...
                        <ul class="ct-docs-nav-sidenav ms-4 ps-1">
                            <li class="">
                                <a href="admin/documentation/getting-started/overview.html">
                                    Overview
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/getting-started/license.html">
                                    License
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/getting-started/installation.html">
                                    Installation
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/getting-started/build-tools.html">
                                    Build Tools
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/getting-started/bootstrap.html">
                                    What is Bootstrap
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="ct-docs-toc-item-active">
                        ...
                        <ul class="ct-docs-nav-sidenav ms-4 ps-1">
                            <li class="">
                                <a href="admin/documentation/laravel/login.html">
                                    Login
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/laravel/sign-up.html">
                                    Sign Up
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/laravel/forgot-password.html">
                                    Forgot Password
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/laravel/reset-password.html">
                                    Reset Password
                                </a>
                            </li>
                            <li class="ct-docs-nav-sidenav-active">
                                <a href="admin/documentation/laravel/user-profile.html">
                                User Profile
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="ct-docs-toc-item-active">
                        ...
                        <ul class="ct-docs-nav-sidenav ms-4 ps-1">
                            <li class="">
                                <a href="admin/documentation/foundation/colors.html">
                                    Colors
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/foundation/grid.html">
                                    Grid
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/foundation/typography.html">
                                    Typography
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/foundation/icons.html">
                                    Icons
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/foundation/utilities.html">
                                    Utilities
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="ct-docs-toc-item-active">
                        ...
                        <ul class="ct-docs-nav-sidenav ms-4 ps-1">
                            <li class="">
                                <a href="admin/documentation/components/alerts.html">
                                    Alerts
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/components/badge.html">
                                    Badge
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/components/buttons.html">
                                    Buttons
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/components/social-buttons.html">
                                    Social Buttons
                                    <span class="ct-docs-sidenav-pro-badge">Pro</span>
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/components/cards.html">
                                    Cards
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/components/carousel.html">
                                    Carousel
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/components/collapse.html">
                                    Collapse
                                    <span class="ct-docs-sidenav-pro-badge">Pro</span>
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/components/dropdowns.html">
                                    Dropdowns
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/components/forms.html">
                                    Forms
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/components/input-group.html">
                                    Input Group
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/components/list-group.html">
                                    List Group
                                    <span class="ct-docs-sidenav-pro-badge">Pro</span>
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/components/modal.html">
                                    Modal
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/components/navs.html">
                                    Navs
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/components/navbar.html">
                                    Navbar
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/components/pagination.html">
                                    Pagination
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/components/popovers.html">
                                    Popovers
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/components/progress.html">
                                    Progress
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/components/spinners.html">
                                    Spinners
                                    <span class="ct-docs-sidenav-pro-badge">Pro</span>
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/components/tables.html">
                                    Tables
                                </a>
                            </li>
                            <li class="">
                                <a href="admin/documentation/components/tooltips.html">
                                    Tooltips
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="ct-docs-toc-item-active">
                        ...
                        <ul class="ct-docs-nav-sidenav ms-4 ps-1">
                        <li class="">
                            <a href="admin/documentation/plugins/countUpJs.html">
                            CountUp JS
                            <span class="ct-docs-sidenav-pro-badge">Pro</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="admin/documentation/plugins/charts.html">
                            Charts
                            </a>
                        </li>
                        <li class="">
                            <a href="admin/documentation/plugins/datepicker.html">
                            Datepicker
                            <span class="ct-docs-sidenav-pro-badge">Pro</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="admin/documentation/plugins/fullcalendar.html">
                            Fullcalendar
                            <span class="ct-docs-sidenav-pro-badge">Pro</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="admin/documentation/plugins/sliders.html">
                            Sliders
                            <span class="ct-docs-sidenav-pro-badge">Pro</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="admin/documentation/plugins/choices.html">
                            Choices
                            <span class="ct-docs-sidenav-pro-badge">Pro</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="admin/documentation/plugins/dropzone.html">
                            Dropzone
                            <span class="ct-docs-sidenav-pro-badge">Pro</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="admin/documentation/plugins/datatables.html">
                            Datatables
                            <span class="ct-docs-sidenav-pro-badge">Pro</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="admin/documentation/plugins/kanban.html">
                            Kanban
                            <span class="ct-docs-sidenav-pro-badge">Pro</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="admin/documentation/plugins/photo-swipe.html">
                            Photo Swipe
                            <span class="ct-docs-sidenav-pro-badge">Pro</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="admin/documentation/plugins/quill.html">
                            Quill
                            <span class="ct-docs-sidenav-pro-badge">Pro</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="admin/documentation/plugins/sweet-alerts.html">
                            Sweet Alerts
                            <span class="ct-docs-sidenav-pro-badge">Pro</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="admin/documentation/plugins/threeJs.html">
                              Three JS
                              <span class="ct-docs-sidenav-pro-badge">Pro</span>
                            </a>
                        </li>
                        <li class="">
                            <a href="admin/documentation/plugins/wizard.html">
                            Wizard
                            <span class="ct-docs-sidenav-pro-badge">Pro</span>
                            </a>
                        </li>
        ...
        <main class="ct-docs-content-col" role="main">
          ...
          <p>The <code>App/Http/Controllers/InfoUserController.php</code>  handles the user's profile information.</p>
          <div class="position-relative">
            <div class="bd-clipboard"><span class="btn-clipboard" title="" data-bs-original-title="Copy to clipboard">Copy</span></div>
...
<script src="admin/../assets/docs.js"></script>
</body>
</html>
